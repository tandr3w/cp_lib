...
while lower_bound <= higher_bound:
    ...
    if (mid_point < leftSum and mid_point < rightSum) or (mid_point == leftSum or mid_point == rightSum): # Optimal solution
        break
    else:
        if mid_point < rightSum: # optimal solution is on the left
